...
```mermaid
graph TD
    A["Prospecto Interesado"] --> B["Simulador Hipotecario (RD$)"]
    B --> C["Mensaje Directo al Agente"]
    C --> D["Envío de Propuesta Económica"]
    D --> E["Aceptación de Oferta (Agente)"]
    E --> F["Cierre de Venta Automático (Vendida)"]
    F --> G["Rechazo en Cascada de Competencia"]
```
