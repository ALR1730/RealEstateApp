    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center pb-4 border-b border-slate-200">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight flex items-center gap-2">
            ...
            Mensajes Directos con Clientes Compradores
          </h2>
          <p className="text-xs text-slate-500 mt-0.5">
            Atención en tiempo real y asesoramiento de clientes por inmueble.
          </p>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 space-y-4">
          ...
          <h3 className="text-base font-bold text-slate-800">No hay mensajes recientes</h3>
          <p className="text-xs text-slate-500 max-w-sm mx-auto">
            Cuando los clientes te envíen preguntas sobre tus inmuebles, aparecerán aquí de inmediato.
          </p>
        </div>
      ) : (
            ...
            {conversations.map((c, i) => (
              ...
              >
                ...
                <div className="overflow-hidden flex-1">
                  <p className="font-bold text-xs truncate text-slate-900">{c.recipientName || 'Cliente'}</p>
