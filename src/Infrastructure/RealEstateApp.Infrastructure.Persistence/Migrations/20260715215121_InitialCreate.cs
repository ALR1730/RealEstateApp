        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontoSeparacion = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PorcentajeInicialRequerido = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MortgageSimulations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MontoInicialAportado = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MortgageSimulations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MortgageSimulations_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MontoOfertado = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ClienteId_PropertyId",
                table: "Favorites",
                columns: new[] { "ClienteId", "PropertyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MortgageSimulations_PropertyId",
                table: "MortgageSimulations",
                column: "PropertyId");
